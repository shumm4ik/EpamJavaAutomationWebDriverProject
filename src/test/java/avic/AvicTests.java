...
public class AvicTests {
    ...
    public void checkThatUrlContainsSearchWord() {
        driver.findElement(xpath("//input[@id='input_search']")).sendKeys("iPhone 13");//вводим в поиск iPhone 11
    ...
    public void checkElementsAmountOnSearchPage() {
        ...
        List<WebElement> elementsList = driver.findElements(By.xpath("//div[@class='prod-cart__descr']"));//собрали элементы поиска в лист
    ...
    public void checkThatSearchResultsContainsSearchWord() {
        ...
        for (WebElement webElement : elementList) { //прошлись циклом и проверили что каждый элемент листа содержит текс iPhone 11
            assertTrue(webElement.getText().contains("iPhone 13"));
        }
    }
